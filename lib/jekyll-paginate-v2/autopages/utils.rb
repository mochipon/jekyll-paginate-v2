module Jekyll
  module PaginateV2::AutoPages
    ...
    class Utils
      ...
      #
      def self.format_tag_macro(toFormat, tag, slugify: true)
        if slugify
      ...
      #
      def self.format_cat_macro(toFormat, category, slugify: true)
        if slugify
      ...
      #
      def self.format_coll_macro(toFormat, collection, slugify: true)
        if slugify
